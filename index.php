...
<body class="bg-dark-bg text-light-surface min-h-screen">
        ...
        <div class="container mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex space-x-8">
                    ...
                    <a href="#articles" class="hover:text-warm-wood transition-colors duration-300 relative group">
                        Articles
                        <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-warm-wood transition-all duration-300 group-hover:w-full"></span>
                    </a>
                ...
                <button class="md:hidden text-light-surface focus:outline-none" onclick="toggleMobileMenu()" title="Open navigation menu" aria-label="Open navigation menu">
            ...
            <div id="mobileMenu" class="hidden md:hidden mt-4 space-y-2">
                <a href="#home" class="block py-2 hover:text-warm-wood transition-colors duration-300">Home</a>
                <a href="#about" class="block py-2 hover:text-warm-wood transition-colors duration-300">About</a>
                <a href="#projects" class="block py-2 hover:text-warm-wood transition-colors duration-300">Projects</a>
                <a href="#articles" class="block py-2 hover:text-warm-wood transition-colors duration-300">Articles</a>
                <a href="#contact" class="block py-2 hover:text-warm-wood transition-colors duration-300">Contact</a>
            </div>
        </div>
    </nav>
    ...
    <section id="home" class="min-h-screen flex items-center justify-center relative overflow-hidden">
        <!-- Background Gradient -->
        <div class="py-20 bg-gradient-to-b from-[#232323] via-[#D4A574]/10 to-[#232323]">
            <!-- Animated Blobs -->
            <div class="absolute top-10 left-10 w-56 h-56 bg-accent-green opacity-30 rounded-full blur-3xl animate-blob1"></div>
            <div class="absolute bottom-20 right-20 w-72 h-72 bg-warm-wood opacity-20 rounded-full blur-3xl animate-blob2"></div>
            <div class="absolute top-1/2 right-1/4 w-40 h-40 bg-light-surface opacity-10 rounded-full blur-2xl animate-blob3"></div>
        </div>
        ...
        <div class="container mx-auto px-6 flex flex-col md:flex-row items-center justify-center relative z-10">
            ...
            <div class="md:w-1/2 text-center md:text-left animate-slide-up">
                <h1 class="text-5xl md:text-7xl font-bold mb-10 text-shadow">
                    <span class="text-light-surface">Hi, I'm</span>
    ...
    <!-- About Section -->
    <section id="about" class="py-20 bg-gradient-to-b from-[#232323] via-[#D4A574]/10 to-[#232323]">
        <div class="container mx-auto px-6">
            <div class="max-w-6xl mx-auto">
                <h2 class="text-4xl md:text-5xl font-bold text-center mb-16 text-warm-wood">About Me</h2>

                <!-- Main About Content -->
                <div class="grid md:grid-cols-2 gap-12 items-center mb-16">
                    <div class="space-y-6 animate-slide-up">
                        <p class="text-lg text-justify text-gray-300 leading-relaxed">
                            <?php echo nl2br(htmlspecialchars($aboutData['main_description'] ?? 'No main description yet.')); ?>
                        </p>
                        <p class="text-lg text-justify text-gray-300 leading-relaxed">
                            <?php echo nl2br(htmlspecialchars($aboutData['additional_description'] ?? 'No additional description yet.')); ?>
                        </p>
                    </div>
                    <div class="flex justify-center animate-slide-up">
                        <img src="<?php echo htmlspecialchars($profile['photo']); ?>" alt="Illustration of <?php echo htmlspecialchars($profile['name']); ?>" class="w-80 h-80 rounded-lg shadow-lg" />
                    </div>
                </div>
                ...
                <div class="mt-20">
                    <div class="grid md:grid-cols-2 gap-12">
                        <!-- Pendidikan -->
                        <div>
                            <h3 class="text-3xl font-bold text-center mb-12 text-warm-wood">Education</h3>
                            <div class="max-w-2xl mx-auto">
                                <?php if (count($educations) > 0): foreach ($educations as $edu): ?>
                                        <div class="glass-effect border border-warm-wood/30 min-h-48 p-8 rounded-2xl animate-fade-in mb-6">
                                            <div class="flex flex-col items-start justify-between">
                                                ...
                                                <div class="mt-4">
                                                    <div class="bg-warm-wood/20 px-4 py-2 rounded-full">
                                                        <span class="text-warm-wood font-medium text-sm">Active</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-gray-400 text-center">No education data available.</div>
                                <?php endif; ?>
                            </div>
                        </div>
                        <!-- Organisasi -->
                        <div>
                            <h3 class="text-3xl font-bold text-center mb-12 text-warm-wood">Organization</h3>
                            <div class="max-w-2xl mx-auto">
                                <?php if (count($organizations) > 0): foreach ($organizations as $org): ?>
                                    ...
                                    <div class="text-gray-400 text-center">No organization data available.</div>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container mx-auto px-6 py-10">
                    <h2 class="text-3xl md:text-4xl font-bold text-center mb-10 text-warm-wood">Latest Activities</h2>
                    <div class="max-w-4xl mx-auto">
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <?php foreach ($activities as $act): ?>
                                    <div class="glass-effect p-6 rounded-xl border border-warm-wood/30 shadow-lg hover:shadow-xl transition-shadow duration-300 flex items-start space-x-4 group">
                                        <!-- Dot Indicator -->
                                        <span class="w-3 h-3 mt-2 bg-warm-wood rounded-full flex-shrink-0 transition-transform duration-300 group-hover:scale-125"></span>

                                        <!-- Activity Content -->
                                        <div>
                                            <p class="text-light-surface font-semibold text-lg mb-1 transition-colors duration-300 ">
                        ...
                        <?php else: ?>
                            <div class="glass-effect p-8 rounded-2xl shadow-inner text-center border border-warm-wood/20 animate-fade-in">
                                <p class="text-gray-400 italic">No activity data available.</p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <section id="projects" class="py-20 bg-gradient-to-b from-[#232323] via-[#D4A574]/10 to-[#232323]">
        <div class="container mx-auto px-3 sm:px-6">
            <div class="flex flex-col sm:flex-row justify-between items-center mb-16">
                <div class="w-full flex justify-center">
                    <h2 class="text-4xl md:text-5xl font-bold text-warm-wood mb-4 sm:mb-0 text-center">Latest Projects</h2>
                </div>
            </div>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            <?php if (count($projects) > 0):
                // Show only 3 latest projects for index page
                $displayProjects = array_slice($projects, 0, 3);
                foreach ($displayProjects as $project): ?>
                    <div class="glass-effect border border-warm-wood/30 min-h-48 p-6 sm:p-8 rounded-2xl animate-fade-in mb-6 flex flex-col h-full bg-gradient-to-br from-[#232323]/80 via-[#D4A574]/10 to-[#232323]/90 w-full max-w-xs mx-auto sm:max-w-none">
                        <?php if (!empty($project['image'])): ?>
                            <div class="flex justify-center mb-4 sm:mb-6 w-full">
                                <img src="<?php echo htmlspecialchars($project['image']); ?>"
                                    alt="<?php echo htmlspecialchars($project['title']); ?>"
                                    class="w-full h-40 object-contain rounded-lg shadow border-2 border-warm-wood bg-glass" />
                            </div>
                        <?php endif; ?>
                        <h3 class="text-xl font-bold mb-2 sm:mb-3 text-light-surface"><?php echo htmlspecialchars($project['title']); ?></h3>
                        <p class="text-gray-300 mb-3 sm:mb-4 text-justify flex-1 text-sm sm:text-base"><?php echo htmlspecialchars($project['description']); ?></p>
                        <div class="flex flex-wrap gap-2 mb-3 sm:mb-4">
                            <?php foreach (array_slice(explode(',', $project['technologies']), 0, 3) as $tech): ?>
                                <span class="bg-dark-bg px-3 py-1 rounded-full text-xs border border-warm-wood/20 text-light-surface"><?php echo htmlspecialchars(trim($tech)); ?></span>
                            <?php endforeach; ?>
                        </div>
                        <div class="mt-auto w-full">
                            <div class="flex flex-col sm:flex-row items-center justify-between gap-3 relative">
                                <?php if (!empty($project['github'])): ?>
                                    <a href="<?php echo htmlspecialchars($project['github']); ?>"
                                        target="_blank"
                                        class="flex items-center gap-2 bg-warm-wood text-dark-bg rounded-lg px-4 py-2 font-medium shadow hover:bg-accent-green hover:text-white transition-all duration-300 w-full sm:w-auto text-center justify-center"
                                        style="min-width:110px;">
                                        Github
                                        <span class="ml-2 text-lg"><i class="fab fa-github"></i></span>
                                    </a>
                                <?php endif; ?>
                                <?php if (!empty($project['demo'])): ?>
                                    <a href="<?php echo htmlspecialchars($project['demo']); ?>"
                                        target="_blank"
                                        class="flex items-center gap-2 bg-accent-green text-dark-bg rounded-lg px-4 py-2 font-medium shadow hover:bg-warm-wood hover:text-white transition-all duration-300 w-full sm:w-auto text-center justify-center"
                                        style="min-width:110px;">
                                        Demo
                ...
                <div class="text-gray-400 text-center w-full col-span-full">No project data available.</div>
            <?php endif; ?>
        </div>
        <?php if (count($projects) > 3): ?>
            <div class="w-full flex justify-center mt-8">
                <button
                    ...
                    View All (<?php echo count($projects); ?>)
                </button>
            </div>
        <?php endif; ?>
    </section>
    ...
    <div id="projectsModal" class="fixed inset-0 z-50 hidden overflow-y-auto transition-all duration-300">
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
            ...
            <!-- Modal Content -->
            <div class="inline-block w-full max-w-6xl p-6 my-8 overflow-hidden align-middle transition-all transform rounded-3xl shadow-2xl border-2 border-warm-wood bg-gradient-to-br from-[#232323]/95 via-[#D4A574]/10 to-[#232323]/95 backdrop-blur-md animate-fade-in"
                ...
                <div class="flex items-center justify-between mb-6 border-b border-warm-wood/40 pb-3">
                    <h3 class="text-2xl sm:text-3xl font-bold text-warm-wood">All Projects</h3>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7">
                    <?php foreach ($projects as $index => $project): ?>
                        <div class="glass-effect rounded-2xl p-6 border-2 border-warm-wood/60 shadow-lg hover:shadow-2xl hover:scale-[1.03] transition-all duration-300 group animate-fade-in flex flex-col h-full bg-gradient-to-br from-[#232323]/80 via-[#D4A574]/10 to-[#232323]/90"
                            ...
                            <div class="flex flex-wrap gap-1.5 mb-5">
                                <?php foreach (array_slice(explode(',', $project['technologies']), 0, 3) as $tech): ?>
                                    <span class="px-2 py-1 text-xs rounded-full bg-dark-bg border border-warm-wood/20 text-light-surface">
                            ...
                            <div class="mt-auto">
                                <div class="flex items-end justify-between h-full">
                                    ...
                                    <?php if (!empty($project['demo'])): ?>
                                        <a href="<?php echo htmlspecialchars($project['demo']); ?>"
                                            target="_blank"
                                            class="flex items-center gap-2 bg-accent-green text-dark-bg rounded-lg px-4 py-2 font-medium shadow hover:bg-warm-wood hover:text-white transition-all duration-300 mt-4"
    ...
    <section id="articles" class="py-20 bg-gradient-to-b from-[#232323] via-[#D4A574]/10 to-[#232323]">
        <div class="container mx-auto px-6">
            <div class="flex flex-col sm:flex-row justify-between items-center mb-16">
                <div class="w-full flex justify-center">
                    <h2 class="text-4xl md:text-5xl font-bold text-warm-wood mb-4 sm:mb-0 text-center">Latest Articles</h2>
                </div>
            </div>
        </div>
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <?php if (count($articles) > 0):
                // Show only 3 latest articles for index page
                $displayArticles = array_slice($articles, 0, 3);
                foreach ($displayArticles as $article): ?>
                    <div class="glass-effect rounded-2xl p-4 sm:p-6 border-2 border-warm-wood/60 shadow-lg hover:shadow-2xl hover:scale-[1.03] transition-all duration-300 group animate-fade-in flex flex-col h-full bg-gradient-to-br from-[#232323]/80 via-[#D4A574]/10 to-[#232323]/90 w-full max-w-xs mx-auto sm:max-w-none">
                        <?php if (!empty($article['image'])): ?>
                            <div class="flex justify-center mb-6">
                                <img src="<?php echo htmlspecialchars($article['image']); ?>"
                                    alt="<?php echo htmlspecialchars($article['title']); ?>"
                                    class="w-full h-40 object-cover rounded-lg shadow border-2 border-warm-wood bg-glass" />
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="flex flex-wrap gap-2 mb-4">
                            <span class="bg-dark-bg px-3 py-1 rounded-full text-xs"><?php echo date('M d, Y', strtotime($article['publish_date'])); ?></span>
                        </div>
                        <div class="mt-auto">
                            <div class="flex items-end justify-between h-full">
                                <a href="articles.php?id=<?php echo $article['id']; ?>"
                                    class="flex items-center gap-2 bg-warm-wood text-dark-bg rounded-lg px-4 py-2 font-medium shadow mt-4 transition-all duration-300 transition-all transform hover:-translate-y-0.5 duration-300"
                                    style="position: absolute; right: 1.25rem; bottom: 1.25rem;">
                                    Read More
                                    <span class="ml-2 text-lg"><i class="fas fa-arrow-right"></i></span>
                                </a>
                ...
                <div class="text-gray-400 text-center w-full col-span-full">No article data available.</div>
            <?php endif; ?>
        </div>
        <?php if (count($articles) > 3): ?>
            <div class="w-full flex justify-center mt-8">
                <button
                    ...
                    class="bg-light-surface/20 backdrop-blur-sm border border-light-surface/30 text-light-surface transition-all duration-300 text-sm font-medium py-2 px-6 rounded-full shadow-md hover:shadow-lg transform hover:-translate-y-0.5 cursor-pointer">
                    View All (<?php echo count($articles); ?>)
                </button>
            </div>
        <?php endif; ?>
        </div>
    ...
    <div id="articlesModal" class="fixed inset-0 z-50 hidden overflow-y-auto transition-all duration-300">
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
            ...
            <div class="inline-block w-full max-w-6xl p-6 my-8 overflow-hidden align-middle transition-all transform rounded-3xl shadow-2xl border-2 border-warm-wood bg-gradient-to-br from-[#232323]/95 via-[#D4A574]/10 to-[#232323]/95 backdrop-blur-md animate-fade-in"
                ...
                <!-- Header -->
                <div class="flex items-center justify-between mb-6 border-b border-warm-wood/40 pb-3">
                    <h3 class="text-2xl sm:text-3xl font-bold text-warm-wood">All Articles</h3>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7">
                    <?php foreach ($articles as $index => $article): ?>
                        <div class="glass-effect rounded-2xl p-6 border-2 border-warm-wood/60 shadow-lg hover:shadow-2xl hover:scale-[1.03] transition-all duration-300 group animate-fade-in flex flex-col h-full bg-gradient-to-br from-[#232323]/80 via-[#D4A574]/10 to-[#232323]/90"
                            ...
                            <div class="mt-auto">
                                <a href="articles.php?id=<?php echo $article['id']; ?>"
                                    class="flex-1 text-center bg-warm-wood rounded-lg text-dark-bg py-2 px-3 text-sm font-medium shadow block transition-all duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:text-white cursor-pointer">
                                    Read More
                                </a>
                            </div>
                        </div>
    ...
    <section id="contact" class="py-20 bg-gradient-to-b from-[#232323] via-[#D4A574]/10 to-[#232323]">
        <div class="max-w-3xl mx-auto flex flex-col items-center">
            <!-- Center: Contact Info & Value per Month -->
            <div class="glass-effect p-8 rounded-2xl shadow-lg w-full mb-10">
                <h2 class="text-3xl md:text-4xl font-bold mb-6 text-warm-wood text-center">Contact Me</h2>
                ...
                <div class="mb-8 glass-effect p-6 rounded-2xl shadow-lg text-center">
                    <div class="text-warm-wood font-semibold text-lg mb-1">Value per Month</div>
                    <div class="text-2xl font-bold text-light-surface">Rp <?php echo number_format($profileData['value_per_month'] ?? 0, 0, ',', '.'); ?>,-</div>
                    <div class="text-xs text-gray-400 mt-1">*Average monthly service/business price</div>
                </div>
                <div class="text-center mb-6">
                    <p class="text-lg text-gray-300">Want to discuss further? Please send a message using the form below.</p>
                </div>
    ...
    <div id="contactModal" class="fixed inset-0 z-50 hidden overflow-y-auto transition-all duration-300">
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
            ...
            <div class="inline-block w-full max-w-lg p-6 my-8 overflow-hidden align-middle transition-all transform rounded-3xl shadow-2xl border-2 border-warm-wood bg-dark-bg/95 backdrop-blur-md animate-fade-in relative"
                ...
                <h2 class="text-2xl font-bold text-warm-wood mb-6 text-center">Send Message</h2>
                <form method="post" action="#contact" class="space-y-6">
                    <div>
                        <label class="block text-sm font-medium mb-2 text-light-surface">Name</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-2 text-light-surface">Message</label>
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['send_message'])) {
                    ...
                    // Redirect to avoid resubmit and trigger toast
                    echo '<script>window.location.href = window.location.pathname + "?sent=1#contact";</script>';
                    exit;
                }
                ?>
            </div>
    ...
    <!-- Toast Notification -->
    <div id="toast-success" class="fixed top-6 left-1/2 -translate-x-1/2 z-[9999] px-6 py-4 rounded-xl shadow-lg bg-green-600 text-white font-semibold text-lg flex items-center gap-3 transition-all duration-500 opacity-0 pointer-events-none" style="min-width:220px">
        <i class="fas fa-check-circle text-2xl"></i>
        <span>Message sent successfully!</span>
    </div>

    <!-- Footer -->
    <footer class="bg-gradient-to-r from-dark-bg to-warm-wood/20 py-8 border-t border-gray-700">
    ...
    <!-- Toast Notification -->
    <div id="toast-success" class="fixed top-6 right-6 z-[9999] hidden bg-green-600 text-white px-6 py-4 rounded-lg shadow-lg flex items-center gap-3 animate-fade-in">
        <i class="fas fa-check-circle text-2xl"></i>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (urlParams.get('sent') === '1') {
                ...
                if (toast) {
                    ...
                    // Hapus query string setelah toast muncul
                    setTimeout(() => {
